...
<div class="teacher-center" v-if="teacherMsg" >
    ...
    <div class="centerInfo" v-if="tabIndex===1">
      ...
      <div class="introduction" v-if="teacherMsg.info.video != ''||teacherMsg.info.intro!=''">
        <h6 class="title intro_icon">自我介绍 
...
export default {
  ...
  methods: {
    ...
    getTag() {
      ...
      this.commentList =[
        {
          avatar:'https://qn-static.landi.com/uploadtoolf7602a9bbe98d0d2b4530375cde51b6a.jpg',
          nickname:'Chocolate',
...
.teacher-center {
  ...
  .centerInfo {
    ...
    .video_icon:before{
      background: url(~assets/good_teacher/images/video_icon.png) no-repeat center
        center/cover;
    }
    .introduction {
      padding: 30px;
